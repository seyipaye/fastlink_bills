...
import 'package:fastlink_app/domain/providers/response/responses.dart';
...
class AppProvider extends GetConnect {
  ...
  Future<(Plans, Discounts)> plans() {
    return get<ApiResponse>('/plans/plans-discounts').then(
      (value) {
        var response;
        ...
        if (response != null) {
          ...
          final plans = (value.body!.data['plans'] as List<dynamic>)
              .map((e) => Plan.fromJson(e as Map<String, dynamic>))
              .toList();

          final discounts = (value.body!.data['discounts'] as List<dynamic>)
              .map((e) => Discount.fromJson(e as Map<String, dynamic>))
              .toList();

                
          response = (plans, discounts);
        }
